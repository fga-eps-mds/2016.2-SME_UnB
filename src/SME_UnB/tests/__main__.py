...
from SME_UnB import __version__
...
def get_parser():
    ...
    """
    parser = argparse.ArgumentParser('SME-UnB')
...
def main(args=None):
    """
    Called with ``python -m SME_UnB.tests``: run main test suite.
    """
    ...
    import SME_UnB.tests as test_module
